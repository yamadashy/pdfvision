...
Tools
  ...
  search_pdf    One row per distinct place a hit lands (same-source, same-region
                occurrences collapse into ×N), with page, origin, optional context,
                region, and a short ref. Names the pages whose native text is
                unusable, so zero hits is not mistaken for absence.
