...
interface VisualRegion {
  ...
  associatedText?: VisualRegionAssociatedText[]; // nearby captions/form labels/image labels/headings included in the region box
