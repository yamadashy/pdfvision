...
| Capture embedded file attachment metadata | `--attachments` | PDFs whose viewer attachment pane exposes supplemental files; emits names, descriptions, and byte sizes without dumping attachment bytes into context |
